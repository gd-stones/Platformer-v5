...
namespace StonesGaming
{
    ...
    public class PlatformerEngine : MonoBehaviour
    {
        ...
        /// <summary>
        /// The distance the _engine will 'slide' to a stop while in the air. Only effects horizontal movement.
        /// </summary>
        ...
        /// <summary>
        /// Should the speed of the _engine change depending of the angle of the slope. This only impacts walking on slopes, not while sliding.
        /// </summary>
        ...
        public bool frozen
        {
            ...
            set
            {
                if (_frozen != value)
                {
                    ...
                    if (_frozen)
                    {
                        _prevState = engineState;
                        engineState = EngineState.Frozen;
                    }
                    else
                    {
                        engineState = _prevState;
                    }
                }
            }
        }
        ...
        public void EndJump()
        {
            if (IsJumping())
            {
                ...
                ChangeState(EngineState.Falling);
            }
        }
        ...
        public void FreedomStateEnter()
        {
            ...
            _velocity.x = 0;
            _ignoreGravity = true;
            ChangeState(EngineState.FreedomState);
        }
        ...
        {
            return engineState == EngineState.Dashing;
        }
        ...
        {
            return engineState == EngineState.FreedomState;
        }
        ...
        {
            return engineState == EngineState.WallSticking;
        }
        ///<summary>
        /// Engine is standing onto something?
        ///</summary>
        public bool IsOnGround()
        {
            return engineState == EngineState.OnGround;
        }
        ///<summary>
        /// Engine is Slipping?
        ///</summary>
        ...
        {
            return engineState == EngineState.Slipping;
        }
        ///<summary>
        /// Engine is on corner?
        ///</summary>
        ...
        {
            return engineState == EngineState.OnCorner;
        }
        ///<summary>
        /// Engine is sliding on wall?
        ///</summary>
        public bool IsWallSliding()
        {
            return engineState == EngineState.WallSliding;
        }
        ///<summary>
        /// Engine is in mid air?
        ///</summary>
        public bool IsInAir()
        {
        ...
        ///<summary>
        /// Engine is sticking on a wall or on corner or slidding on a wall.
        ///</summary>
        ...
        ///<summary>
        /// Engine is standing on the floor. Does not include Sliding
        ///</summary>
        ...
        private EngineState _prevState;
        ...
        private Bounds _startPosEngine;
        private Bounds _movedPosEngine;
        ...
        {
            public MovingPlatformEngine platform;
        ...
        private void UpdateState(bool forceSurroundingsCheck)
        {
            ...
            if (IsDashing())
            {
                ...
                _dashing.distanceDashed += (_collider2D.bounds.center - _prevLocation).magnitude;
                return;
            }
            ...
            if (IsGrounded())
            {
                ...
                if (IsForceSlipping() && _velocity != Vector2.zero && Mathf.Sign(_velocity.x) == Mathf.Sign(slopeDir.x))
                {
                    ...
                    ChangeState(EngineState.Slipping);
                }
                else
                {
                    ChangeState(EngineState.OnGround);
            ...
            {
                _movingPlatformState.prevPosition = _movingPlatformState.platform.position;
            }
        ...
        private float UpdateEngine(float deltaTime)
        {
        ...
        private bool UpdateMovingPlatform()
        {
            ...
            if (movingPlatformDebug)
            {
                ...
                _movedPosEngine = new Bounds();
                _startPosEngine = new Bounds();
            }

            // Update location if on a moving platform.
            if (!IsDashing() && _movingPlatformState.isOnPlatform)
            {
                Vector3 toNewPos = _movingPlatformState.platform.position - _movingPlatformState.prevPosition;
        ...
        private void RaycastAndSeparate(Vector2 dir, float distance)
        {
            ...
            if (hit.collider != null)
            {
                ...
                if (movingPlatformDebug)
                {
                    ...
                    _startPosEngine = _collider2D.bounds;
                }
                ...
                if (movingPlatformDebug)
                {
                    _movedPosEngine = _collider2D.bounds;
                }
            }
        }
        ...
        {
            float diffInPositions = Mathf.Abs(_collider2D.bounds.center.y - _prevLocation.y);
        ...
        private void AttachToMovingPlatforms()
        {
            ...
            MovingPlatformEngine previous = _movingPlatformState.platform;
            _movingPlatformState.platform = null;
            ...
            {
                _movingPlatformState.platform = _collidersUpAgainst[DIRECTION_DOWN].GetComponent<MovingPlatformEngine>();
            ...
            {
                _movingPlatformState.platform = _collidersUpAgainst[DIRECTION_RIGHT].GetComponent<MovingPlatformEngine>();
            ...
            {
                if (_movingPlatformState.platform.onPlatformerEngineContact != null)
                {
                    _movingPlatformState.platform.onPlatformerEngineContact.Invoke(this);
                }
            }
        }
        ...
        private void HandlePreJumping()
        {
            ...
            if (_jumping.pressed)
            {
                ...
                if (jumped)
                {
                    ...
                    ChangeState(EngineState.Jumping);
                }
            }
        ...
        private void HandlePostWallInteraction()
        {
            ...
            else
            {
                if (IsOnCorner())
                {
                    ...
                    {
                        ChangeState(enableWallSlides ? EngineState.WallSliding : EngineState.Falling);
                    }
                }
        ...
        private void HandlePreWallInteraction()
        {
            ...
            if (enableCornerGrabs)
            {
                if (_isValidWallInteraction && _velocity.y <= 0 && CheckIfAtCorner() && _wallInfo.canHangAgain)
                {
                    ...
                    ChangeState(EngineState.OnCorner);
                    return;
                }
            }
            ...
            if (enableWallSticks)
            {
                if (_isValidWallInteraction && _velocity.y <= 0 && (PressingIntoLeftWall() || PressingIntoRightWall()) && _wallInfo.canHangAgain)
                {
                    ...
                    _velocity = Vector2.zero;
                    _wallInfo.canHangAgain = false;
                    ChangeState(EngineState.WallSticking);
                    return;
                }
            }
                ...
                !IsOnCorner())
            {
                ...
                {
                    ChangeState(EngineState.WallSliding);
                }
            }
        ...
        private void HandleFalling()
        {
            ...
            if (IsInAir() && !_ignoreGravity)
            {
                ...
                if (fallFast)
                {
                    ...
                    if (_velocity.y <= 0)
                    {
                        ChangeState(EngineState.FallingFast);
                    }
                }
                else
                {
        ...
        private void ApplyMovement()
        {
            ...
            else if (Mathf.Abs(normalizedXMovement) > 0)
            {
                if (IsGrounded())
                {
                    ...
                    {
                        // If we're moving faster than our normalizedXMovement * _groundSpeed then decelerate rather than accelerate.
        ...
        private void StartDash()
        {
            ...
            ChangeState(EngineState.Dashing);
        }
                    ...
                    _hits[i].collider.GetComponent<PlatformEffector2D>().useOneWay)
                {
                    ...
                    if (isTouching)
                    {
                        if (checkWereTouching && ((1 << _hits[i].collider.gameObject.layer) & movingPlatformLayerMask) != 0)
                        {
                            ...
                            MovingPlatformEngine mpEngine = _hits[i].collider.GetComponent<MovingPlatformEngine>();
                            Vector3 curPos = mpEngine.transform.position;
                            mpEngine.transform.position = mpEngine.prevPosition;
                    ...
                    else if (((1 << _hits[i].collider.gameObject.layer) & movingPlatformLayerMask) != 0)
                    {
                        ...
                        if (_movingPlatformState.platform != mpEngine)
                        {
                            // This might break for more complicated one way platform moving platforms but it'll have to do.
                            if (mpEngine.velocity != Vector2.zero)
                            {
                                dot = Vector3.Dot(oneWayPlatformForward, -velocity);
                            }
                            else
                            {
                                Vector2 toNewPlatformPos = mpEngine.position - mpEngine.prevPosition;
